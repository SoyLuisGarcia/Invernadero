...
public class TablaFotoController {
	GraficasDao daoH = new GraficasDao();
	...
	private void generar(ActionEvent event) throws Exception {
		...
		xAxis.setCategories(daoH.listarfoto1(leyenda));
		grafica.getData().addAll(daoH.listarfoto2(leyenda));
	...
	public void atras() {
		...
		main.getStageGraficaFoto().close();
	}
}
