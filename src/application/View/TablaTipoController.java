...
public class TablaTipoController {
	...
	private void generar(ActionEvent event) throws Exception {
		...
		xAxis.setCategories(daoG.listarTipo1(leyenda));
		grafica.getData().addAll(daoG.listarTipo2(leyenda));
	...
	public void atras() {
		...
		main.getStageGraficaTipo().close();
	}
}
