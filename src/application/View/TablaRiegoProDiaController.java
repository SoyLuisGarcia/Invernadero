...
public class TablaRiegoProDiaController {
	...
	private void generar(ActionEvent event) throws Exception {
		...
		xAxis.setCategories(daoG.listarRiegoPorDia1(leyenda));
		grafica.getData().addAll(daoG.listarRiegoPorDia2(leyenda));
	...
	public void atras() {
		...
		main.getStageGraficaRiegoProDia().close();;
	}
}
